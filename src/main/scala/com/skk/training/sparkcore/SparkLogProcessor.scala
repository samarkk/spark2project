...
object SparkLogProcessor {
  def main(args: Array[String]) {
    ...
    // takes up about 155/160 MB of storage - 160954498 against
    // 125/130 MB for kryo - 133834536
    ...
    val dailyUniqueHosts = accessLogs.map(x =>
      (x.dateTime.substring(0, 2).toInt, x.ipAddress)).
    ...
    assert(dailyRequests.collect.toSet == Set((4, 59554), (16, 56651), (8, 60142), (12, 38070), (20, 32963),
      (13, 36480), (21, 55539), (1, 33996), (17, 58980), (9, 60457), (5, 31888),
      (22, 57758), (14, 59873), (6, 32416), (18, 56244), (10, 61245), (19, 32092),
      (15, 58845), (11, 61242), (3, 41387), (7, 57355)))
    ...
    // find out the  5 most frequent bad hosts
    // - do a count descending for the ipAddress part of the bad hosts
